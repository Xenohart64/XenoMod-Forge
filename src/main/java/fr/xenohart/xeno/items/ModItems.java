...
import fr.xenohart.xeno.armor.CustomArmorTiers;
import fr.xenohart.xeno.entities.ModEntityTypes;
import fr.xenohart.xeno.fluid.ModFluids;
import fr.xenohart.xeno.tools.CustomItemTiers;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> OBSIDIAN_SWORD = Registration.ITEMS.register("obsidian_sword", () -> new SwordItem(CustomItemTiers.OBSIDIAN, 2, -2.4f, defaultBuilderCombat().maxStackSize(1)));
    public static final RegistryObject<Item> OBSIDIAN_SHOVEL = Registration.ITEMS.register("obsidian_shovel", () -> new ShovelItem(CustomItemTiers.OBSIDIAN, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> OBSIDIAN_PICKAXE = Registration.ITEMS.register("obsidian_pickaxe", () -> new PickaxeItem(CustomItemTiers.OBSIDIAN, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> OBSIDIAN_AXE = Registration.ITEMS.register("obsidian_axe", () -> new AxeItem(CustomItemTiers.OBSIDIAN, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> OBSIDIAN_HOE = Registration.ITEMS.register("obsidian_hoe", () -> new HoeItem(CustomItemTiers.OBSIDIAN, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> OBSIDIAN_HELMET = Registration.ITEMS.register("obsidian_helmet", () -> new ArmorItem(CustomArmorTiers.OBSIDIAN, EquipmentSlotType.HEAD, defaultBuilderCombat()));
    public static final RegistryObject<Item> OBSIDIAN_CHESTPLATE = Registration.ITEMS.register("obsidian_chestplate", () -> new ArmorItem(CustomArmorTiers.OBSIDIAN, EquipmentSlotType.CHEST, defaultBuilderCombat()));
    public static final RegistryObject<Item> OBSIDIAN_LEGGINGS = Registration.ITEMS.register("obsidian_leggings", () -> new ArmorItem(CustomArmorTiers.OBSIDIAN, EquipmentSlotType.LEGS, defaultBuilderCombat()));
    public static final RegistryObject<Item> OBSIDIAN_BOOTS = Registration.ITEMS.register("obsidian_boots", () -> new ArmorItem(CustomArmorTiers.OBSIDIAN, EquipmentSlotType.FEET, defaultBuilderCombat()));
//    public static final RegistryObject<Item> HORSE_ARMOR_OBSIDIAN = Registration.ITEMS.register("horse_armor_obsidian", () -> new ModHorseArmorItem(11, CustomArmorTiers.OBSIDIAN.getName(), unstackable()));
    ...
    public static final RegistryObject<Item> SILVER_SWORD = Registration.ITEMS.register("silver_sword", () -> new SwordItem(CustomItemTiers.SILVER, 2, -2.4f, defaultBuilderCombat().maxStackSize(1)));
    public static final RegistryObject<Item> SILVER_SHOVEL = Registration.ITEMS.register("silver_shovel", () -> new ShovelItem(CustomItemTiers.SILVER, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> SILVER_PICKAXE = Registration.ITEMS.register("silver_pickaxe", () -> new PickaxeItem(CustomItemTiers.SILVER, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> SILVER_AXE = Registration.ITEMS.register("silver_axe", () -> new AxeItem(CustomItemTiers.SILVER, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> SILVER_HOE = Registration.ITEMS.register("silver_hoe", () -> new HoeItem(CustomItemTiers.SILVER, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
...
//    public static final RegistryObject<Item> HORSE_ARMOR_STEEL = Registration.ITEMS.register("horse_armor_steel", () -> new ModHorseArmorItem(11, CustomArmorTiers.STEEL.getName(), unstackable()));
    ...
    public static final RegistryObject<Item> RUBY_SWORD = Registration.ITEMS.register("ruby_sword", () -> new SwordItem(CustomItemTiers.RUBY, 2, -2.4f, defaultBuilderCombat().maxStackSize(1)));
    public static final RegistryObject<Item> RUBY_SHOVEL = Registration.ITEMS.register("ruby_shovel", () -> new ShovelItem(CustomItemTiers.RUBY, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> RUBY_PICKAXE = Registration.ITEMS.register("ruby_pickaxe", () -> new PickaxeItem(CustomItemTiers.RUBY, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> RUBY_AXE = Registration.ITEMS.register("ruby_axe", () -> new AxeItem(CustomItemTiers.RUBY, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> RUBY_HOE = Registration.ITEMS.register("ruby_hoe", () -> new HoeItem(CustomItemTiers.RUBY, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> RUBY_HELMET = Registration.ITEMS.register("ruby_helmet", () -> new ArmorItem(CustomArmorTiers.RUBY, EquipmentSlotType.HEAD, defaultBuilderCombat()));
    public static final RegistryObject<Item> RUBY_CHESTPLATE = Registration.ITEMS.register("ruby_chestplate", () -> new ArmorItem(CustomArmorTiers.RUBY, EquipmentSlotType.CHEST, defaultBuilderCombat()));
    public static final RegistryObject<Item> RUBY_LEGGINGS = Registration.ITEMS.register("ruby_leggings", () -> new ArmorItem(CustomArmorTiers.RUBY, EquipmentSlotType.LEGS, defaultBuilderCombat()));
    public static final RegistryObject<Item> RUBY_BOOTS = Registration.ITEMS.register("ruby_boots", () -> new ArmorItem(CustomArmorTiers.RUBY, EquipmentSlotType.FEET, defaultBuilderCombat()));
//    public static final RegistryObject<Item> HORSE_ARMOR_RUBY = Registration.ITEMS.register("horse_armor_ruby", () -> new ModHorseArmorItem(11, CustomArmorTiers.RUBY.getName(), unstackable()));
    ...
    public static final RegistryObject<Item> SAPHIR_SWORD = Registration.ITEMS.register("saphir_sword", () -> new SwordItem(CustomItemTiers.SAPHIR, 2, -2.4f, defaultBuilderCombat().maxStackSize(1)));
    public static final RegistryObject<Item> SAPHIR_SHOVEL = Registration.ITEMS.register("saphir_shovel", () -> new ShovelItem(CustomItemTiers.SAPHIR, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> SAPHIR_PICKAXE = Registration.ITEMS.register("saphir_pickaxe", () -> new PickaxeItem(CustomItemTiers.SAPHIR, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> SAPHIR_AXE = Registration.ITEMS.register("saphir_axe", () -> new AxeItem(CustomItemTiers.SAPHIR, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> SAPHIR_HOE = Registration.ITEMS.register("saphir_hoe", () -> new HoeItem(CustomItemTiers.SAPHIR, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    ...
    public static final RegistryObject<Item> SAPHIR_HELMET = Registration.ITEMS.register("saphir_helmet", () -> new ArmorItem(CustomArmorTiers.SAPHIR, EquipmentSlotType.HEAD, defaultBuilderCombat()));
    public static final RegistryObject<Item> SAPHIR_CHESTPLATE = Registration.ITEMS.register("saphir_chestplate", () -> new ArmorItem(CustomArmorTiers.SAPHIR, EquipmentSlotType.CHEST, defaultBuilderCombat()));
    public static final RegistryObject<Item> SAPHIR_LEGGINGS = Registration.ITEMS.register("saphir_leggings", () -> new ArmorItem(CustomArmorTiers.SAPHIR, EquipmentSlotType.LEGS, defaultBuilderCombat()));
    public static final RegistryObject<Item> SAPHIR_BOOTS = Registration.ITEMS.register("saphir_boots", () -> new ArmorItem(CustomArmorTiers.SAPHIR, EquipmentSlotType.FEET, defaultBuilderCombat()));
//    public static final RegistryObject<Item> HORSE_ARMOR_SAPHIR = Registration.ITEMS.register("horse_armor_saphir", () -> new ModHorseArmorItem(11, CustomArmorTiers.SAPHIR.getName(), unstackable()));
    ...
    //emerald
    public static final RegistryObject<Item> EMERALD_SWORD = Registration.ITEMS.register("emerald_sword", () -> new SwordItem(CustomItemTiers.EMERALD, 2, -2.4f, defaultBuilderCombat().maxStackSize(1)));
    public static final RegistryObject<Item> EMERALD_SHOVEL = Registration.ITEMS.register("emerald_shovel", () -> new ShovelItem(CustomItemTiers.EMERALD, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> EMERALD_PICKAXE = Registration.ITEMS.register("emerald_pickaxe", () -> new PickaxeItem(CustomItemTiers.EMERALD, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> EMERALD_AXE = Registration.ITEMS.register("emerald_axe", () -> new AxeItem(CustomItemTiers.EMERALD, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    public static final RegistryObject<Item> EMERALD_HOE = Registration.ITEMS.register("emerald_hoe", () -> new HoeItem(CustomItemTiers.EMERALD, 2, -2.4f, defaultBuilderTools().maxStackSize(1)));
    ...
    public static final RegistryObject<Item> EMERALD_HELMET = Registration.ITEMS.register("emerald_helmet", () -> new ArmorItem(CustomArmorTiers.EMERALD, EquipmentSlotType.HEAD, defaultBuilderCombat()));
    public static final RegistryObject<Item> EMERALD_CHESTPLATE = Registration.ITEMS.register("emerald_chestplate", () -> new ArmorItem(CustomArmorTiers.EMERALD, EquipmentSlotType.CHEST, defaultBuilderCombat()));
    public static final RegistryObject<Item> EMERALD_LEGGINGS = Registration.ITEMS.register("emerald_leggings", () -> new ArmorItem(CustomArmorTiers.EMERALD, EquipmentSlotType.LEGS, defaultBuilderCombat()));
    public static final RegistryObject<Item> EMERALD_BOOTS = Registration.ITEMS.register("emerald_boots", () -> new ArmorItem(CustomArmorTiers.EMERALD, EquipmentSlotType.FEET, defaultBuilderCombat()));
...
//    public static final RegistryObject<Item> CHERRY = Registration.ITEMS.register("cherry", () -> new Item(defaultBuilderFood().food(Foods.APPLE)));
    ...
    public static final RegistryObject<Item> FROST_BOW = Registration.ITEMS.register("frost_bow", () -> new BowItem((defaultBuilderCombat().maxStackSize(1)).maxDamage(384)));
    public static final RegistryObject<Item> FIRE_BOW = Registration.ITEMS.register("fire_bow", () -> new BowItem((defaultBuilderCombat().maxStackSize(1)).maxDamage(384)));
    ...
    public static final RegistryObject<ModSpawnEggItem> BOAR_SPAWNING_EGG = Registration.ITEMS.register("boar_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.BOAR, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> DUCK_SPAWNING_EGG = Registration.ITEMS.register("duck_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.DUCK, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> MOOBLOOM_SPAWNING_EGG = Registration.ITEMS.register("moobloom_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.MOOBLOOM, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> CLUCKSHROOM_SPAWNING_EGG = Registration.ITEMS.register("cluckshroom_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.CLUCKSHROOM, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    ...
    public static final RegistryObject<ModSpawnEggItem> RAINBOW_SHEEP_SPAWNING_EGG = Registration.ITEMS.register("rainbow_sheep_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.RAINBOW_SHEEP, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> JOLLY_LLAMA_SPAWNING_EGG = Registration.ITEMS.register("jolly_llama_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.JOLLY_LLAMA, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> WOOLY_COW_SPAWNING_EGG = Registration.ITEMS.register("wooly_cow_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.WOOLY_COW, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> BONE_SPIDER_SPAWNING_EGG = Registration.ITEMS.register("bone_spider_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.BONE_SPIDER, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    ...
    public static final RegistryObject<ModSpawnEggItem> VILER_WITCH_SPAWNING_EGG = Registration.ITEMS.register("viler_witch_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.VILER_WITCH, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    public static final RegistryObject<ModSpawnEggItem> BEAR_SPAWNING_EGG = Registration.ITEMS.register("bear_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.BEAR, 0xF02F4A,0x7034F1, defaultBuilderMiscellaneous()));
    ...
    public static Item.Properties defaultBuilderDecoration() { return new Item.Properties().group(XenoMod.XENO_DECORATION); }

    public static Item.Properties defaultBuilderRedstone() { return new Item.Properties().group(XenoMod.XENO_REDSTONE); }

    public static Item.Properties defaultBuilderCombat() {
        return new Item.Properties().group(XenoMod.XENO_COMBAT);
    }

    public static Item.Properties defaultBuilderTools() {
        return new Item.Properties().group(XenoMod.XENO_TOOLS);
    }

    public static Item.Properties defaultBuilderFood() {
        return new Item.Properties().group(XenoMod.XENO_FOOD);
    }

    public static Item.Properties defaultBuilderMiscellaneous() { return new Item.Properties().group(XenoMod.XENO_MISCELLANEOUS); }

    public static Item.Properties unstackable() {
        return defaultBuilderMiscellaneous().maxStackSize(1);
    }
