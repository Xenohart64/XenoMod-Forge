...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> RUBY_ORE = register("ruby_ore", () -> new OreBlock(BlockBehaviour.Properties.of(Material.STONE)));
    ...
    public static final RegistryObject<Block> SAPHIR_ORE = register("saphir_ore", () -> new OreBlock(BlockBehaviour.Properties.of(Material.STONE)));

    public static final RegistryObject<Block> SILVER_ORE = register("silver_ore", () -> new OreBlock(BlockBehaviour.Properties.of(Material.STONE)));
