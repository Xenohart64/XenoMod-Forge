...
import fr.xenohart.xeno.entities.*;
...
//            GlobalEntityTypeAttributes.put(ModEntityTypes.MUDDY_PIG.get(), MuddyPigEntity.setCustomAttributes().create());
    ...
    public static final ItemGroup XENO_BLOCK = new ItemGroup("xeno_block"){
        @Override
    ...
    public static final ItemGroup XENO_DECORATION = new ItemGroup("xeno_decoration"){
        @Override
        public ItemStack createIcon(){
            return new ItemStack(ModBlocks.BUTTERCUP.get());
        }
    };

    public static final ItemGroup XENO_REDSTONE = new ItemGroup("xeno_redstone"){
        @Override
        public ItemStack createIcon(){ return new ItemStack(ModBlocks.REDSTONE_DUST_BLUE.get()); }
    };

    public static final ItemGroup XENO_MISCELLANEOUS = new ItemGroup("xeno_miscellaneous"){
        @Override
        public ItemStack createIcon(){
    ...
    public static final ItemGroup XENO_FOOD = new ItemGroup("xeno_food"){
        @Override
        public ItemStack createIcon(){ return new ItemStack(ModItems.DIAMOND_APPLE.get()); }
    };

    public static final ItemGroup XENO_TOOLS = new ItemGroup("xeno_tools"){
        @Override
        public ItemStack createIcon(){
    ...
    public static final ItemGroup XENO_COMBAT = new ItemGroup("xeno_combat"){
        @Override
        public ItemStack createIcon(){
