package fr.xenohart.xeno.entities.slimes;
...
public class BlueSlimeGelLayer<T extends LivingEntity> extends LayerRenderer<T, BlueSlimeModel<T>> {
    private final EntityModel<T> slimeModel = new BlueSlimeModel<>(0);

    public BlueSlimeGelLayer(IEntityRenderer<T, BlueSlimeModel<T>> p_i50923_1_) {
        super(p_i50923_1_);
    }
