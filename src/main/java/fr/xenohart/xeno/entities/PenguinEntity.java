...
public class PenguinEntity extends AnimalEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(9, new LookAtGoal(this, PenguinEntity.class, 6.0F));
...
//    }
    ...
    public static boolean canPenguinSpawn(EntityType<? extends PenguinEntity> animal, IWorld world, SpawnReason reason, BlockPos pos, Random random) {
    ...
    private class EntityAIExtinguishFire extends PanicGoal {
        ...
        public boolean shouldExecute() {
            return (PenguinEntity.this.isChild() || PenguinEntity.this.isBurning()) && super.shouldExecute();
        }
    }
}
