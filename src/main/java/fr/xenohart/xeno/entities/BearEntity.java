...
public class BearEntity extends AnimalEntity implements IAngerable {
        private static final DataParameter<Boolean> IS_STANDING = EntityDataManager.createKey(BearEntity.class, DataSerializers.BOOLEAN);
   ...
   public BearEntity(EntityType<? extends BearEntity> type, World worldIn) {
        ...
        protected void registerGoals() {
            ...
            this.goalSelector.addGoal(1, new BearEntity.MeleeAttackGoal());
            this.goalSelector.addGoal(1, new BearEntity.PanicGoal());
            this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.25D));
            this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 1.0D));
            this.goalSelector.addGoal(6, new LookAtGoal(this, PlayerEntity.class, 6.0F));
            this.goalSelector.addGoal(7, new LookRandomlyGoal(this));
            this.targetSelector.addGoal(1, new BearEntity.HurtByTargetGoal());
            this.targetSelector.addGoal(2, new BearEntity.AttackPlayerGoal());
        ...
        public static boolean func_223320_c(EntityType<BearEntity> p_223320_0_, IWorld p_223320_1_, SpawnReason
        reason, BlockPos p_223320_3_, Random p_223320_4_) {
        ...
        class AttackPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
            public AttackPlayerGoal() {
                super(BearEntity.this, PlayerEntity.class, 20, true, true, (Predicate<LivingEntity>)null);
            }
            ...
            public boolean shouldExecute() {
                if (BearEntity.this.isChild()) {
                    return false;
                } else {
                    if (super.shouldExecute()) {
                        for(BearEntity Bearentity : BearEntity.this.world.getEntitiesWithinAABB(BearEntity.class, BearEntity.this.getBoundingBox().grow(8.0D, 4.0D, 8.0D))) {
                            if (Bearentity.isChild()) {
                                return true;
                            }
                        }
                    }
        ...
        class HurtByTargetGoal extends net.minecraft.entity.ai.goal.HurtByTargetGoal {
            ...
            protected void setAttackTarget(MobEntity mobIn, LivingEntity targetIn) {
                if (mobIn instanceof BearEntity && !mobIn.isChild()) {
        ...
        class MeleeAttackGoal extends net.minecraft.entity.ai.goal.MeleeAttackGoal {
            public MeleeAttackGoal() {
                super(BearEntity.this, 1.25D, true);
            }
        ...
        class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal {
             ...
             */
            public boolean shouldExecute() {
                return !BearEntity.this.isChild() && !BearEntity.this.isBurning() ? false : super.shouldExecute();
            }
        }
}
