...
public class RainbowSheepEntity extends SheepEntity {
    ...
    public RainbowSheepEntity func_241840_a(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        ...
        RainbowSheepEntity sheepentity1 = ModEntityTypes.RAINBOW_SHEEP.get().create(p_241840_1_);
        return sheepentity1;
    }
...
//        } else {
//            return ModLootTables.ENTITIES_RAINBOW_SHEEP_WOOL;
//        }
//    }
    ...
    public void shear(SoundCategory category) {
        ...
        for (int j = 0; j < i; ++j) {
            ItemEntity itementity = this.entityDropItem(ModBlocks.RAINBOW_WOOL.get(), 1);
            if (itementity != null) {
    ...
    public java.util.List<ItemStack> onSheared(@Nullable PlayerEntity player, @javax.annotation.Nonnull ItemStack item, World world, BlockPos pos, int fortune) {
        ...
        if (!world.isRemote) {
            ...
            for (int j = 0; j < i; ++j) {
                items.add(new ItemStack(ModBlocks.RAINBOW_WOOL.get()));
            }
            return items;
        }
