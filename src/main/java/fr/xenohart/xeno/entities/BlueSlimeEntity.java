...
public class BlueSlimeEntity  extends MobEntity implements IMob {
    private static final DataParameter<Integer> SLIME_SIZE = EntityDataManager.createKey(BlueSlimeEntity.class, DataSerializers.VARINT);
    public float squishAmount;
    public float squishFactor;
    public float prevSquishFactor;
    private boolean wasOnGround;

    protected BlueSlimeEntity(EntityType<? extends MobEntity> type, World worldIn) {
        super(type, worldIn);
        this.moveController = new BlueSlimeEntity.MoveHelperController(this);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new BlueSlimeEntity.FloatGoal(this));
        this.goalSelector.addGoal(2, new BlueSlimeEntity.AttackGoal(this));
        this.goalSelector.addGoal(3, new BlueSlimeEntity.FaceRandomGoal(this));
    ...
    public EntityType<? extends BlueSlimeEntity> getType() {
        return (EntityType<? extends BlueSlimeEntity>)super.getType();
    }
    ...
    public void remove(boolean keepData) {
        ...
        if (!this.world.isRemote && i > 1 && this.getShouldBeDead() && !this.removed) {
            ...
            for(int l = 0; l < k; ++l) {
                ...
                BlueSlimeEntity BlueSlimeEntity = this.getType().create(this.world);
                if (this.isNoDespawnRequired()) {
                    BlueSlimeEntity.enablePersistence();
                }

                BlueSlimeEntity.setCustomName(itextcomponent);
                BlueSlimeEntity.setNoAI(flag);
                BlueSlimeEntity.setInvulnerable(this.isInvulnerable());
                BlueSlimeEntity.setSlimeSize(j, true);
                BlueSlimeEntity.setLocationAndAngles(this.getPosX() + (double)f1, this.getPosY() + 0.5D, this.getPosZ() + (double)f2, this.rand.nextFloat() * 360.0F, 0.0F);
                this.world.addEntity(BlueSlimeEntity);
            }
        }
    ...
    public static boolean func_223366_c(EntityType<BlueSlimeEntity> p_223366_0_, IWorld p_223366_1_, SpawnReason reason, BlockPos p_223366_3_, Random randomIn) {
    ...
    static class AttackGoal extends Goal {
        ...
        public AttackGoal(BlueSlimeEntity slimeIn) {
            this.slime = slimeIn;
        ...
        public boolean shouldExecute() {
            ...
            if (livingentity == null) {
                ...
                return livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).abilities.disableDamage ? false : this.slime.getMoveHelper() instanceof BlueSlimeEntity.MoveHelperController;
            }
        }
        ...
        public void tick() {
            ...
            ((BlueSlimeEntity.MoveHelperController)this.slime.getMoveHelper()).setDirection(this.slime.rotationYaw, this.slime.canDamagePlayer());
        }
    }
    ...
    static class FaceRandomGoal extends Goal {
        ...
        public FaceRandomGoal(BlueSlimeEntity slimeIn) {
            this.slime = slimeIn;
            this.setMutexFlags(EnumSet.of(Goal.Flag.LOOK));
        }
         ...
         */
        public boolean shouldExecute() {
            return this.slime.getAttackTarget() == null && (this.slime.onGround || this.slime.isInWater() || this.slime.isInLava() || this.slime.isPotionActive(Effects.LEVITATION)) && this.slime.getMoveHelper() instanceof BlueSlimeEntity.MoveHelperController;
        }
        ...
        public void tick() {
            ...
            ((BlueSlimeEntity.MoveHelperController)this.slime.getMoveHelper()).setDirection(this.chosenDegrees, false);
        }
    }
    ...
    static class FloatGoal extends Goal {
        ...
        public FloatGoal(BlueSlimeEntity slimeIn) {
            this.slime = slimeIn;
         ...
         */
        public boolean shouldExecute() {
            return (this.slime.isInWater() || this.slime.isInLava()) && this.slime.getMoveHelper() instanceof BlueSlimeEntity.MoveHelperController;
        }
        ...
        public void tick() {
            ...
            ((BlueSlimeEntity.MoveHelperController)this.slime.getMoveHelper()).setSpeed(1.2D);
        }
    }
